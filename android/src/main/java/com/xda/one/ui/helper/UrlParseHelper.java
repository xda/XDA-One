...
public class UrlParseHelper {
    ...
    private static void parseThreadUrl(final Context context,
                                       final Uri uri,
                                       final Consumer<Fragment> success,
    ...
    private static void getPostFeed(final Context context,
                                    final Consumer<Fragment> success,
                                    final Runnable failure,
                                    final String threadId,
                                    final int page) {
        final PostClient userClient = RetrofitPostClient.getClient(context);
        userClient.getPostsAsync(threadId, page, new Callback<PostContainer>() {
            @Override
            public void success(final PostContainer container, final Response response) {
