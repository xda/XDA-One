 ...
 */
public class XDALinerLayoutManager extends RecyclerView.LayoutManager {
    ...
    private static final String TAG = "XDALinerLayoutManager";
     ...
     * helps {@link XDALinerLayoutManager} make those decisions.
     ...
     */
    public XDALinerLayoutManager(Context context, int orientation, boolean reverseLayout) {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        state.mScrollX = mScrollX;
        state.mScrollY = mScrollY;
        return state;
    }
        ...
        LinearSmoothScroller linearSmoothScroller =
                new LinearSmoothScroller(recyclerView.getContext()) {
                    ...
                    public PointF computeScrollVectorForPosition(int targetPosition) {
                        return XDALinerLayoutManager.this
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (mPendingSavedState != null) {
            ...
            mScrollX = mPendingSavedState.mScrollX;
            mScrollY = mPendingSavedState.mScrollY;
        }
    ...
    void ensureRenderState() {
        if (mRenderState == null) {
            ...
            mRenderState.mExtra = getPaddingTop();
        }
    ...
    private int scrollBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (mOrientation == VERTICAL) {
            mScrollY = Math.max(mScrollY + scrolled, 0);
        } else if (mOrientation == HORIZONTAL) {
            mScrollX = Math.max(mScrollX + scrolled, 0);
        }
